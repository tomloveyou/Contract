...
package personcom.yl.contract.widget.recycleview.adapter;
...
public abstract class EasyRecyclerViewAdapter
    ...
    private EasyRecyclerViewHolder.OnItemTouchListener onItemTouchListener;
    ...
    @Override public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        try {
            ...
            easyRecyclerViewHolder.setOnItemLongClickListener(this.onItemLongClickListener,
                    position);
            easyRecyclerViewHolder.setOnItemTouchListener(this.onItemTouchListener,position);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
     ...
     * @param onItemLongClickListener onItemLongClickListener
     */
    public void setOnItemTouchListener(EasyRecyclerViewHolder.OnItemLongClickListener onItemLongClickListener) {
        this.onItemLongClickListener = onItemLongClickListener;
    }
}
