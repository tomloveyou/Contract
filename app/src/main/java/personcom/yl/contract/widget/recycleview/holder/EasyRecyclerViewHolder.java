...
package personcom.yl.contract.widget.recycleview.holder;
...
public class EasyRecyclerViewHolder extends RecyclerView.ViewHolder {
     ...
     * @param position position
     */
    public void setOnItemTouchListener(final EasyRecyclerViewHolder.OnItemTouchListener listener, final int position) {
        if (listener == null) {
            this.itemView.setOnLongClickListener(null);
        } else {
            this.itemView.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    listener.onItemTouchClick(v,position,event);
                    return true;
                }
            });
        }
    ...
    public interface OnItemTouchListener {
         ...
         * @return true false
         */
        boolean onItemTouchClick(View convertView, int position,MotionEvent event);
    }
}
